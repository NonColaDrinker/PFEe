...
<html lang="fr">
  ...
  <body style="background-color: #f2f2f2;">
    ...
    <form action="./supprimer.php?type=pub" method="post" id="asupprimer" onsubmit="return confirmer()">
        <div class="row">
          <div class="col-25">
          </div>
          <div class="col-75">
          <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 100%;">
            ...
            while($row =mysqli_fetch_assoc($lignes) ){
                echo "<tr><td>" . htmlspecialchars($row['pubID']) . "</td><td>" . htmlspecialchars($row['cont']) . "</td><td>". htmlspecialchars($row['persID']) . "</td><td>"." <input type=\"checkbox\" class=\"supprimer-checkbox\" data-id=\"".intval($row['pubID'])."\"></td></tr>";
